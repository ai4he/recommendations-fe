...
def get_recommendations_unsup_dynamic(
    ...
    #print("Taken tasks:", chosen_tasks)
    #print("Available tasks:", avail_tasks["Task"].tolist())
    #print("All tasks ids:", all_tasks_df["Task"].tolist())

    #print(all_tasks_df[numeric_features + categorical_features].head(28))
    ...
    def create_task_dict(row, idx):
        ...
        task_dict["model_score"] = float(similarities[idx]) if similarities is not None else 0.0
        return task_dict
